...
//               <div
//                 key={index}
//                 className={`p-4 rounded-lg shadow-sm ${index % 2 === 0 ? "border-yellow-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 bg-gray-900 text-white" : "bg-gray-900 text-white"}`}
//               >
//                 <p>
//                   <strong>{comment.name}:</strong> {comment.text}
//                 </p>
